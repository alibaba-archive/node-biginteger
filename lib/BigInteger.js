...
BigInteger.fromLong = function (val) {
  var _bigInteger = new BigInteger();
  if (val.compare(Long.fromInt(0)) < 0) {
    val = val.negate();
...
/**
 * Returns a BigIntegerTest whose value is x to the power of y mod z.
 ...
 * BigIntegerTest (the number of zero bits to the right of the rightmost
 * one bit).  Returns -1 if this BigIntegerTest contains no one bits.
 * (Computes {@code (this==0? -1 : log2(this & -this))}.)
 *
 * @return index of the rightmost one bit in this BigIntegerTest.
 */
...
/**
 * Returns a BigIntegerTest whose value is {@code (this}<sup>-1</sup> {@code mod m)}.
 *
 * @param  m the modulus.
 * @return {@code this}<sup>-1</sup> {@code mod m}.
 * @throws ArithmeticException {@code  m} &le; 0, or this BigIntegerTest
 *         has no multiplicative inverse mod m (that is, this BigIntegerTest
...
/**
 * Returns a BigIntegerTest whose value is (this ** exponent) mod (2**p)
 */
...
/**
 * Returns a BigIntegerTest whose value is {@code (this<sup>2</sup>)}.
 *
...
/**
 * Returns a BigIntegerTest whose value is this mod(2**p).
 * Assumes that this {@code BigIntegerTest >= 0} and {@code p > 0}.
 */
...
/**
 * Returns a BigIntegerTest whose value is
 ...
 *         negative and this BigIntegerTest is not <i>relatively
 *         prime</i> to {@code m}.
 * @see    #modInverse
 */
