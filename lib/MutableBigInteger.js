...
/**
 * Convert this MutableBigIntegerTest into an int array with no leading
 * zeros, of a length that is equal to this MutableBigIntegerTest's intLen.
 */
...
/**
 * Returns true iff this MutableBigIntegerTest has a value of zero.
 */
...
/**
 * Returns true iff this MutableBigIntegerTest has a value of one.
 */
...
/**
 * Returns true iff this MutableBigIntegerTest is even.
 */
...
/**
* Return the index of the lowest set bit in this MutableBigIntegerTest. If the
* magnitude of this MutableBigIntegerTest is zero, -1 is returned.
*/
 ...
 * result into this MutableBigIntegerTest.
 */
...
/**
 * Sets this MutableBigIntegerTest's value array to a copy of the specified
...
/**
 * Multiply the contents of this MutableBigIntegerTest by the word y. The
...
MutableBigInteger.prototype.mul = function (y, z) {
  ...
  for (var i = this.intLen-1; i >= 0; i--) {
      var product = ylong.multiply(Long.fromNumber(value[i+this.offset] >>> 32)).add(carry);
...
/**
 * Multiply the contents of two MutableBigIntegerTest objects. The result is
 * placed into MutableBigIntegerTest z. The contents of y are not changed.
 */
...
/**
 * Adds the contents of two MutableBigIntegerTest objects.The result
 * is placed within this MutableBigIntegerTest.
